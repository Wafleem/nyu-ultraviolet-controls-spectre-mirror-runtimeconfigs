...
// Forward declarations for HAL handles used by IMU module (defined in CubeMX generated files)
typedef struct __SPI_HandleTypeDef SPI_HandleTypeDef; // opaque here; include spi.h in implementation
